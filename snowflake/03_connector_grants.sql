...
/* Future grants so runtime role can read dynamic tables + streams
   created by OF_KAFKA_ADMIN (needed for the Kafka Sink connector) */
GRANT SELECT ON FUTURE DYNAMIC TABLES IN SCHEMA OF_KAFKA.INGEST
    TO ROLE OF_KAFKA_RUNTIME_ROLE;

GRANT SELECT ON FUTURE STREAMS IN SCHEMA OF_KAFKA.INGEST
    TO ROLE OF_KAFKA_RUNTIME_ROLE;
